...
public final class ItemContainerRecentConversionBinding implements ViewBinding {
  ...
  @NonNull
  public final TextView textDateSend;
  ...
  private ItemContainerRecentConversionBinding(@NonNull ConstraintLayout rootView,
      @NonNull RoundedImageView imageProfile, @NonNull TextView textDateSend,
      @NonNull TextView textName, @NonNull TextView textRecentMessage,
      @NonNull View viewSupporter) {
    this.rootView = rootView;
    this.imageProfile = imageProfile;
    this.textDateSend = textDateSend;
  ...
  public static ItemContainerRecentConversionBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.textDateSend;
      TextView textDateSend = ViewBindings.findChildViewById(rootView, id);
      if (textDateSend == null) {
        break missingId;
      }
      ...
      return new ItemContainerRecentConversionBinding((ConstraintLayout) rootView, imageProfile,
          textDateSend, textName, textRecentMessage, viewSupporter);
    }
